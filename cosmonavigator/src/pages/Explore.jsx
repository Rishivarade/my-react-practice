  ...
  return (
    ...
    <div className="div" style={{ textAlign: "center" }}>
      ...
      <div className="container-fluid col-11 mt-5" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <a className='col-1 text-center pt-2 pb-2' href='#go' style={{ textDecoration: "none", backgroundColor: "black", alignContent: "center", color: "white", fontFamily: "din-2014,helvetica,ssans-serif" }}>GO <br /> UP</a>
      </div>
